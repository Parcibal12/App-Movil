 ...
 * EJERCICIO 16:
 * 
 * 16. Manejo de Nulos (5 puntos): Corrige este código para manejar valores nulos:
 ...
 * - Salida esperada: Dominio: universidad.com
 *
 * CASO 2: Entrada con un valor nulo (el caso a corregir)
...
val email: String? = null
val dominio = email?.substringAfter("@") ?: "no definido"
println("Dominio: $dominio") 